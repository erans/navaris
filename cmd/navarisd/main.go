...
func parseFlags() config {
	...
	flag.Float64Var(&cfg.firecrackerVcpuHeadroomMult, "firecracker-vcpu-headroom-mult", 2.0, "boot-time vCPU headroom multiplier on Firecracker (>=1.0); a value of 1.0 disables headroom")
	flag.Float64Var(&cfg.firecrackerMemHeadroomMult, "firecracker-mem-headroom-mult", 2.0, "boot-time memory headroom multiplier on Firecracker (>=1.0); a value of 1.0 disables headroom")
