...
- **End-to-end browser test.** The UI test plan is unit-level (per `2026-04-07-webui-design.md:33` non-goal on Playwright). The puppeteer probe script used for diagnosing the delete-button regression is a one-off dev tool, not a committed test.
